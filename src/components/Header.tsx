...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className={`sticky top-0 z-30 border-b border-cyan-500/20 bg-[#020d14]/95 backdrop-blur-md transition-all ${
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between sm:justify-center flex-wrap gap-1.5 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {onDisconnectApiKey && (
              <button
                ...
                className="px-2 py-1 rounded-lg text-[11px] font-bold flex items-center space-x-1 border border-rose-500/40 bg-rose-950/40 text-rose-300 hover:bg-rose-900/60 transition-all shadow-xs shrink-0"
                title="Sair"
              >
