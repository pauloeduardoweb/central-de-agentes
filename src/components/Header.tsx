      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            title="Clique para ver ou alterar sua chave da API do Gemini"
          >
            <Key className="w-4 h-4 shrink-0" />
            <span className="hidden sm:inline">
              {hasApiKey ? 'Chave API Conectada' : 'Digitar Chave API'}
            </span>
            {hasApiKey ? (
          ...
          {hasApiKey && (
            <button
              ...
              title="Desconectar e remover chave API e código do navegador"
            >
              <LogOut className="w-3.5 h-3.5 shrink-0" />
              <span className="hidden md:inline">Desconectar Chave API</span>
